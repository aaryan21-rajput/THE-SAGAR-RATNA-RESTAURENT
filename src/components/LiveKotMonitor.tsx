      ...
      <div className="border border-stone-150/80 rounded-2xl overflow-hidden bg-white/50">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-stone-50/80 border-b border-stone-200/80 text-[10px] uppercase tracking-wider font-bold text-stone-505 font-mono">
              ...
              <div className="space-y-6 overflow-y-auto pr-1">
                ...
                <div className="grid grid-cols-2 gap-4 bg-white/70 border border-stone-250/20 p-4 rounded-2xl text-xs shadow-xs">
                  <div>
                    ...
                    <span className="font-bold text-stone-800">Sagar Ratna Subhash Nagar</span>
                  </div>
                  <div>
                    <span className="text-stone-400 font-mono text-[10px] uppercase block">Seated Table</span>
                    <span className="font-mono font-black text-stone-900 bg-stone-100 border border-stone-200 px-20 py-0.5 rounded">T-{selectedKot.tableNumber}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="font-mono text-stone-605">{new Date(selectedKot.createdAt).toLocaleString()}</span>
                  </div>
                </div>
