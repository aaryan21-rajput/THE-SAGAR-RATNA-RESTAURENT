          ...
          {specials.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white border border-stone-150 rounded-3xl overflow-hidden hover:border-[#d4af37]/50 transition-all duration-300 flex flex-col sm:flex-row group shadow-[0_4px_20px_rgba(0,0,0,0.02)] hover:shadow-[0_10px_35px_rgba(212,175,55,0.06)] relative"
              >
                {/* Visual Image Banner with badges */}
                <div className="w-full sm:w-2/5 relative min-h-[220px] sm:min-h-full">
                  <img
                    src={item.image}
                    alt={item.name}
                    ...
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-white/95 via-transparent to-transparent sm:from-transparent sm:to-white" />
                  
                  {/* Organic Badge Overlay */}
                  <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-2 py-2 rounded-lg border border-stone-150 flex items-center justify-center shadow-sm">
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between relative z-10">
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-2">
                      ...
                      <span className="text-emerald-700 text-[10px] sm:text-xs font-mono font-bold tracking-widest bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded uppercase">
