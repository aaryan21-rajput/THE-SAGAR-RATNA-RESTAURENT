...
export default function App() {
  ...
  // Simple, elegant client router logic supporting hash and pathname locations
  const [view, setView] = useState<"menu" | "admin">(
    window.location.pathname === "/admin" || window.location.hash === "#admin" ? "admin" : "menu"
  );
  ...
  const handleAdminLogout = () => {
    ...
    sessionStorage.removeItem("sr_admin_jwt");
    setAdminToken(null);
    setView("menu");
  ...
  return (
    <div className="bg-[#FAF9F5] min-h-screen text-stone-800 flex flex-col font-sans select-none antialiased selection:bg-[#d4af37] selection:text-black">
      ...
      {/* Guest reviews ledger testimonials submission */}
      <Reviews />
